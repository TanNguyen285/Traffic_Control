...
class Simple_CNN(nn.Module):
    def __init__(self, num_classes=2):
        ...
        self.blocks = nn.Sequential(
            ...
            # Layer 3: EB2 (Stride 2 -> Giảm kích thước ảnh đi 1/2)
            ...
            # Layer 5: EB4 (Stride 2 -> Giảm kích thước ảnh đi 1/2)
            ...
            # Layer 7: EB6 (Stride 2 -> Giảm kích thước ảnh đi 1/2 cuối cùng)
...
if __name__ == "__main__":
    ...
    print(f"Kích thước tensor đầu ra (Logits): {output.shape}")
