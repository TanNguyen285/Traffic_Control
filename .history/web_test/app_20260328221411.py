...
from web_test.ethernet import EthernetService
...
from logic2 import TrafficLogic      # "Bộ não" điều phối toàn bộ luồng xử lý AI
...
uart = UARTService(port="/dev/ttyAMA0", baudrate=115200)
