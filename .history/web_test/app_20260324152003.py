...
from engine import TrafficEngine  # File logic bạn vừa tách
...
engine = TrafficEngine(ai_yolo, cnn_net, cnn_transform, Config.CNN_CLASSES, Config.DEVICE, pre_proc, uart, cam)
